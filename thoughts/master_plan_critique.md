...
### 🔴 3. Envelope Integrity: Unsealed UFH & dMVHR Penetrations
**The Flaw:** The plan brilliantly updated the dehumidifier to a zero-penetration "Smart Tank" model, and handles electrical sockets with airtight Kaiser boxes. However, it completely ignores the penetrations required for the **dMVHR ventilation units** (100mm–150mm core holes straight through the wall) and the **16mm PEX UFH manifold plumbing** coming through the floor/wall junction. If these punch through the Intello Plus VCL without certified EPDM airtightness collars (e.g., Pro Clima Roflex), the Passivhaus envelope will haemorrhage warm, moist air into the cold exterior wall cavity, causing immediate interstitial rot.
...
| **Hard-Bonded Floor Risk** | **Polished Concrete** or **Minimum 30mm Screed over UFH**. | The plan specifies fully gluing an aesthetic floor (LVT/Timber) directly to the concrete. Because woodworking machines will eventually gouge this floor, replacing glued tiles requires mechanical grinding. The plan must specify a minimum 30mm protective concrete/screed cover over the 16mm PEX pipes to safely allow for future surface grinding, or switch to a Polished Concrete finish (no glue required). |

...
| **Anti-Rodent Mesh** | 6mm x 6mm Welded Wire Mesh (Galvanised or 316 Stainless) | **Top Attachment:** Stapled securely to the flat outer face of the timber ring beam (just beneath the Aluminium Starter Track). **Bottom Attachment:** Drops down to the pit floor, flares outwards by 150mm into an "L-shape", and is buried under the 50mm gravel ballast. | **The Barrier:** Completely seals the void from rodents. By attaching to the *outer* face of the ring beam, it sits directly behind the ventilated sub-skirt, preventing mice from climbing through the skirt gaps into the joists. | 1 Roll (20m x 0.9m) |
| **Ventilated Sub-Skirt** | Treated Timber Slats or Composite Decking boards | Screwed horizontally into vertical timber battens that are fixed to the outer ring beam (over the rodent mesh). 10mm-15mm gaps between each slat. | **Aesthetic & Airflow:** Hides the steel mesh and void, while the 15mm gaps ensure the sub-floor receives constant wind cross-ventilation. | ~18 linear meters |

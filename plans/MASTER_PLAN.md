...
| **6. Aluminium EWI Starter Track (Base Profile)** | 60mm wide Aluminium U-Channel with Drip Edge | Screwed horizontally into the Compacfoam and Ring Beam, exactly perfectly level at the +20mm mark. | Acts as the structural "shelf" that the XPS skirt and Wood Fibre sit inside. Keeps the bottom edge perfectly straight, prevents pests chewing up into the insulation, and forms a drip-edge to kick water away from the void. | ~17.7 linear meters |

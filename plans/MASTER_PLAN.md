...
| **3. The Compacfoam Splash Zone** | **Compacfoam CF200** Block (150mm high x 140mm wide) | Bedded in structural epoxy continuously around the 17.7m perimeter of the flush concrete slab. | **Moisture Defence & Thermal Break:** Elevates the timber SIPs 150mm above the ground lawn (satisfying the upsplash requirement) without raising the internal concrete floor. Rot-proof and structural. | ~17.7 linear meters |
| **4. DPM / DPC Lapping** | 1200-gauge DPM & Polymeric DPC | DPM folded over slab edge, DPC laid strictly on top of the Compacfoam CF200 ring. | Seals the concrete slab moisture away from the internal space. | 1 Roll DPC |
| **5. Structural Anchoring** | M12 A4 (316) Stainless Anchor Bolts (250mm long) | Embedded 100mm into concrete via chemical resin @ 1200mm centers | Passes through the timber sole plate, through the 150mm Compacfoam block, and into the concrete. Locks the frame down. | ~16 units |
...
| Material Name | Dimensions / Gauge | Fixing Method | Purpose | Estimated Quantity |
| :--- | :--- | :--- | :--- | :--- |
| **1. Waterproofing Deck** | 1.5mm EPDM Membrane | Fully adhered to the glass tissue-faced PIR using manufacturer-approved EPDM-to-PIR adhesive | 50-year seamless weather protection. The membrane sits above the warm over-roof insulation, fully adhered to the textured, semi-porous glass tissue face. | ~22m² sheet |
| **2. Warm Over-Roof Insulation** | 100mm Flat Glass Tissue-Faced PIR Board | Bonded to the sloped SIP outer OSB skin with compatible PU adhesive; staggered joints, tightly butted, no gaps | Creates a continuous warm roof layer above the outer SIP skin. The mineral-coated glass tissue facing is designed specifically to receive fully adhered EPDM. Keeps the upper OSB skin and splines warm and dry, completely eliminating interstitial condensation risk. | ~20m² coverage |
...
| **4. Wall Top Plate** | Pre-Machined Sloped Timber Plate (Supplied by New Forest SIPs to match 120mm core width and 1:60 fall) | Glued and screwed into the top rebate of the wall SIPs | Provides continuous structural bearing while setting the roof SIPs to the required drainage pitch. | ~17.7 linear meters |

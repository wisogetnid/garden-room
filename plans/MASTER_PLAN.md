...
| Material Name | Dimensions / Gauge | Fixing Method | Purpose | Estimated Quantity |
| :--- | :--- | :--- | :--- | :--- |
| **1. Waterproofing Deck** | 1.5mm EPDM Membrane | Fully adhered to the tissue-faced PIR using manufacturer-approved EPDM-to-PIR adhesive | 50-year seamless weather protection. The membrane now sits above the warm over-roof insulation, rather than directly on the SIP OSB skin. | ~22m² sheet |
| **2. Warm Over-Roof Insulation** | 50mm Flat Tissue-Faced PIR Board | Bonded to the sloped SIP outer OSB skin with compatible PU adhesive; staggered joints, tightly butted, no gaps | Creates a continuous warm roof layer above the outer SIP skin. This keeps the upper OSB skin warmer and drier, reducing condensation and damp-risk at the external SIP layer while avoiding the cost of a bespoke tapered PIR package. | ~20m² coverage |
| **3. Sloped Roof Structure** | 150mm New Forest SIP Base Roof Panel, factory/set-out to 1:60 fall | Spanning from wall to wall, joined via insulated splines; slope generated by the SIP support geometry/top plates, not tapered insulation | Provides structural diaphragm action and the drainage fall across the 3430mm core span. The PIR layer above remains constant thickness. | 18.6m² coverage |
| **4. Wall Top Plate** | Pre-Machined Sloped Timber Plate (Supplied by New Forest SIPs to match core width and 1:60 fall) | Glued and screwed into the top rebate of the wall SIPs | Provides continuous structural bearing while setting the roof SIPs to the required drainage pitch. | ~17.7 linear meters |
...
*   **External Height Physics (The 2.5m Limit):**
    ...
    *   Maximum 'High-Side' Wall Height: 2133mm
    *   Low-Side Wall Height: 2133mm - 57.2mm fall = **2076mm**
    *   Total Roof Buildup: 217mm (1.5mm EPDM + 50mm flat PIR + 150mm SIP + 0.5mm VCL + 15mm Fermacell)
    *   **Total Maximum External Height:** 2500mm high side / **2443mm** low side (Legal Pass)
*   **Internal Ceiling Heights (accounting for 22mm hard-bonded flooring):**
    *   **High Side:** 2133mm wall - 22mm floor = **2111mm (approx. 6 ft 11.1 in)**
    *   **Low Side:** 2133mm - 57mm drop = 2076mm wall. 2076mm - 22mm floor = **2054mm (approx. 6 ft 8.9 in)**
...
*   **Opening Validation Rule:** Maintain a minimum **~100mm structural head zone** between the top of any factory-cut opening and the underside of the sloped roof SIP/top-plate bearing zone. This invalidates the previous 2100mm door/glazing datum.
    *   High-side West wall maximum finished opening top datum: 2133mm wall - 22mm finished floor - 100mm head zone = **2011mm**. Adopt **2000mm** maximum finished opening top datum.
    *   Low-side/East or sloped end-wall maximum finished opening top datum: 2076mm wall - 22mm finished floor - 100mm head zone = **1954mm**. Adopt **1950mm** maximum finished opening top datum.
...
| Material Name | Dimensions / Gauge | Fixing Method | Purpose | Estimated Quantity |
| :--- | :--- | :--- | :--- | :--- |
| **Roof Fall Setup** | Sloped SIP roof support geometry | Factory-cut/sloped wall top plates and roof SIP bearing line set to 1:60 across the 3430mm width | Creates a permanent **1:60 fall** directing water across the width without purchasing a bespoke tapered PIR package. Flat 50mm PIR follows this slope above the SIP. | 1 roof set-out package |
...
| **Roof Structure** | Sloped 150mm New Forest SIP Base Roof Panel + 50mm Flat PIR Warm Over-Roof | 0.13 W/m²K | **~0.12 W/m²K** | Flat PIR above the SIP improves thermal performance and keeps the outer SIP OSB skin in a warmer, drier condition. Door and glazing datums are reduced to preserve structural head clearance. |

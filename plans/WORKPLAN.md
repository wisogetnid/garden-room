...
*   **Friday (Delivery):** The 150mm wall and 150mm sloped roof PUR-Core SIP delivery from New Forest SIPs (Lymington) arrives via Yarmouth ferry. *CRITICAL LOGISTICS:* Verify that your delivered timber top/sole plates are pre-machined by New Forest SIPs to perfectly match the internal PUR core rebate width and set the roof bearing line to a **1:60 fall across the 3430mm width**. Confirm the dMVHR wall sleeve opening has been factory-cut in the agreed wall bay and does not interrupt SIP splines, glazing jambs, or top-plate bearing zones. The final mile to the Cowes site has narrow roads. Transfer the panels to a **rigid shuttle vehicle** from any articulated lorries before crossing/navigating the island. Stack the OSB panels flat on bearers under a completely waterproof tarp.
...
*   **Saturday (Heavy/Dangerous):** 
    ...
    *   **Execution:** Slide the roof panels up onto the sloped wall plates/top bearing geometry. Glue and screw the splines exactly as you did the walls. Confirm the SIP roof surface itself falls at **1:60** before adding insulation; do not rely on PIR to create the slope. Tape internal joints with Tescon Vana.
*   **Sunday (Weather-Tight):** Tape all external roof joints. Bond **flat 50mm tissue-faced PIR boards** directly to the sloped top OSB skin of the roof SIP using compatible PU adhesive. Stagger and tightly butt all PIR joints. Next, directly glue the 1.5mm EPDM rubber membrane onto the tissue-face of the PIR using manufacturer-approved adhesive. Roll it flat to remove bubbles. *Foreman Warning:* Do not substitute foil-faced PIR unless the EPDM adhesive manufacturer confirms compatibility; failed adhesion leaves the roof membrane vulnerable to wind uplift.

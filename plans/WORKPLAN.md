...
*   **Friday Logistics:** Waste removal calculation updated to match JACKODUR® specifications. The existing 2.4m x 3.6m x 0.1m concrete patch is ~0.9m³ of solid concrete (~2 tonnes). To accommodate the 3.43x5.43m tub, the manufacturer requires a 400mm working space all around. You must excavate a **4.23m x 6.23m footprint** down to a uniform 350mm depth (150mm MOT + 50mm sand + 150mm JACKODUR). *Foreman Note:* By accepting a 0.22 W/m²K U-value with 150mm XPS instead of aiming for 0.13 W/m²K (which would require 260mm XPS and a 460mm deep hole), you've saved yourself from excavating an extra ~3 tonnes of heavy clay. Your back will thank the architect. You must dig out ~9.2m³ of solid soil (~13.8 tonnes) from beneath the pad and the rest of the garden. **Total waste: ~15.8 tonnes / ~13.2m³ (loose volume).** Since you are digging manually, we are splitting this over two weekends. Do not hire expensive "Mixed Waste" skips. Separate your waste streams: Hire **1x 2-yard "Mini" Clean Hardcore skip** for the concrete, and **3x to 4x sequential 6-yard "Inert Soil/Muck" skips** for the earth. Order the 2-yard Mini Skip for today.

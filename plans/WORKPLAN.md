...
*   **Friday (Delivery):** The 150mm wall and 150mm sloped roof PUR-Core SIP delivery from New Forest SIPs (Lymington) arrives via Yarmouth ferry. *CRITICAL LOGISTICS:* Verify that your delivered timber top/sole plates are pre-machined by New Forest SIPs to perfectly match the internal PUR core rebate width and set the roof bearing line to a **1:60 fall across the 3430mm width**. The final mile to the Cowes site has narrow roads. Transfer the panels to a **rigid shuttle vehicle** from any articulated lorries before crossing/navigating the island. Stack the OSB panels flat on bearers under a completely waterproof tarp.

...
layout: default
---
# SITE MANAGER'S WORKPLAN: Cowes High-Performance EPS-Core SIPS Workshop (3.6 x 5.116m)

**Status:** ACTIVE BUILD SCHEDULE  
**Foreman:** The DIY Project Coach  
**Target:** 14.53m² Net Usable Footprint (16.78m² Structural Core / 18.42m² Gross External) via 125mm Wall / 125mm Roof EPS-Core SIPs  
**Boundary Basis:** Relocated to ≥1000mm from the North, South and East boundaries measured to the outermost projection (roof oversail + fascia + gutter). Core order size **3408 x 4924mm**. Building sits **354mm further west** than originally set out.  
...
*   **The Big Win:** You have 3 existing concrete slabs buried 300mm down. Do not dig them out. a specialist ground screw contractor will arrive and drive **2050mm ground screws** on a grid of **3267mm E-W × 4783mm N-S** (setting-out diagonal **5792mm**), breaking out the slabs locally where a screw position falls on one, and working safely around the oak tree roots. 🚨 **The screw count is NOT yet fixed — 12 or 14 depending on the installer's load test.** If the test achieves ≥60kN ultimate, the original 12 stand. If it returns ~45kN, either a pair of extra screws is added to the two long perimeter lines (14 total, 4 bays @ 1195.75mm) or the four highest-loaded screws are lengthened. *Foreman Note: do not let the installer set out from the current issue of drawing 26C070/1 — it still shows the old 3408 x 5408 footprint. Get the revised drawing or the new grid in writing first. See MASTER_PLAN §1.2a.*
...
*   **Saturday (High Focus):** Inject expanding PU foam into the SIP rebates and drop the 125mm wall panels over the anchored sole plates on the ring beam. SIP panel sizes: West wall 4924mm × 2223.5mm high; East wall 4924mm × 2166.7mm high; North/South 3158mm wide. Join panels using insulated splines and structural polyurethane adhesive. Clamp down with heavy washers and locking nuts over the M12 studs. *Foreman Note: Plumb the base perfectly.*
...
*   **Saturday (Heavy/Dangerous):** Slide the 600mm narrow-format roof panels up onto the sloped wall plates. Join roof panels using structural C24 timber splines, glue, and screws. **Critical:** Ensure the engineered **120mm** overhang is maintained on all four sides (96mm rainscreen buildup + 24mm drip projection). Assembled roof plane = **3648 x 5164mm**. Confirm the SIP roof surface itself falls at **1:60** across the short width before adding insulation. Tape internal roof joints with Tescon Vana.
*   **Sunday (Weather-Tight):** Tape all external roof joints. Install 80mm timber kerb batten on edge around perimeter. Bond flat 80mm high-compressive strength flat PIR (Kingspan TR27) directly to the sloped top OSB skin of the roof SIP. Directly glue the 1.5mm EPDM rubber membrane onto the PIR.
...
*   **Rainscreen Battens:** Screw **25x50mm treated rainscreen battens @ 400mm centers** vertically over the Tyvek using 150mm A4 EWI screws driven in alternating 60°/90° angles (Truss-Screw method). Staple **Perforated Bug Mesh** across the bottom 25mm gap between battens (cavity air inlet at +50mm). **Also fit the ~18.6 lm top vent trim now:** staple the Perforated Aluminium Vent Trim to the underside of the cantilevered SIP roof soffit, bridging the 25mm batten gap (§2.6 item 5). *Foreman Note: this is the cavity's only air outlet and it MUST go on before the top Hardie plank — once the top course is fixed you cannot reach it.*

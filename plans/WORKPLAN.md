...
1.  **The 'Big Event' Protocol:** For major milestones (Slab Pour, SIP Delivery, Roof Lift), you need a 48-hour countdown checklist. These are strictly reserved for weekends. You don't do these alone. Get mates. Buy pizza.
...
*   **🚨 EXPOSED EXCAVATION PROTOCOL (The Multi-Week Trench):** Because you are digging this over 2-3 weeks, you have an unfinished, exposed earthen trench. **DO NOT leave it unprotected during the workweek.** A 490mm deep hole of this size will become a swimming pool if it rains. If water saturates the bottom clay/soil (the 'formation level'), it will turn to mush and ruin the load-bearing capacity for your MOT. 
...
*   **Sunday Lockdown & Weatherproofing:** Because these are naked OSB SIPs, **they must be protected from coastal rain immediately.** Attach the 50mm thick XPS Skirt to the outer face of the Compacfoam. Wrap the entire wall structure in Tyvek breather membrane before leaving the site today. Tape the bottom edge of the Tyvek firmly to the XPS Skirt, pull it taut vertically, and staple/tape it directly into the exposed timber top-plate. Cover the open roof span with a massive heavy-duty tarp, tied down securely.

### Weekend 10: 🚨 BIG EVENT: The Roof Lift
*   **Saturday (Heavy/Dangerous):** Slide the 600mm narrow-format roof panels up onto the sloped wall plates. Join the roof panels using structural LVL splines, glue, and screws. Confirm the SIP roof surface itself falls at **1:60** before adding insulation. Tape internal joints with Tescon Vana.
...
*   **Weeknights (Quiet, 45m-1.5h):** Working under the new roof, cut and friction-fit the **50mm Rigid Wood Fibre external insulation** between the battens. This is clean, quiet work perfect for evenings. 
